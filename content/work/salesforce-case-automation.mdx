...
- **Would do differently — skip n8n.** I'd initially scoped this as an n8n workflow because the visual-DAG framing seemed like the right shape. It wasn't. The logic was simple enough that pure Python was lower friction. I lost three days proving this to myself; should have been the first hour's reading.
