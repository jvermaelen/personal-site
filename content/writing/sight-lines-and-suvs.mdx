---
title: "I thought cars were rear-ending SUVs more often. The data says no."
slug: "sight-lines-and-suvs"
date: "2026-06-07"
dek: "I drove a low-slung Honda Accord for years, and felt taller vehicles in front of me made everything harder to see. I went looking for the data."
tags: ["essay"]
readTime: "~10 min"
status: "Drafting"
draft: true
...
So the sedan I used to drive sees roughly the same amount of road today as it did twenty years ago. The compact SUV class I now drive sees less than half of what its 1997 ancestor saw. The visibility gap I felt is real, and it is mostly the SUV that changed, not the sedan. That is the mechanism this analysis was built to test.
...
I used NHTSA's Fatality Analysis Reporting System (FARS), an annual census of every fatal traffic crash on US public roads since 1975. "Fatal" here means a crash where at least one person died within thirty days. The full pipeline (download, body-type crosswalk, five analyses, statistical helpers, and tests) lives in the companion repo at [github.com/jvermaelen/cars-vs-suvs-crashes](https://github.com/jvermaelen/cars-vs-suvs-crashes). The repo is private at the time of writing and will flip public alongside this post.

A note on the timeline. I show data from 1975 because that is when FARS starts, but I run regressions and quote slope numbers only from 2002 onward. Two reasons. First, 2002 was the year light trucks (SUVs, pickups, vans together) first outsold passenger cars in the US. It is the rhetorical line for "SUVs took over." Second, FARS body-type codes were reorganized in 1991, and even with my crosswalk repaired against the FARS Analytical User's Manual, the pre-2002 series has residual seams. Showing it for context is fine. Quoting a slope across it would be misleading.
...
The seam to flag: EPA's regulatory categories (Truck SUV vs Car SUV) do not map perfectly onto the FARS body codes I am using. The light-truck share I am dividing by is the closest available denominator, not a pristine one. The shape of the result (a ratio below 1.0 and falling) holds up under reasonable variations in that denominator. The exact level is more sensitive.
...
- **FARS is fatalities-only.** A "rear-end crash" in this analysis is one that killed someone. The vast majority of rear-end crashes in the US do not kill anyone and are not in this data. CRSS (the police-reported sample, 2016 onward) is the right extension and was out of scope here.
...
Notebooks, helper modules, tests, and every CSV that backs a number in this post are in the companion repo at [github.com/jvermaelen/cars-vs-suvs-crashes](https://github.com/jvermaelen/cars-vs-suvs-crashes). The repo is private at the time of writing and will flip public alongside this post.
...
**CRSS** - Crash Report Sampling System. NHTSA's probability sample of police-reported crashes, 2016-present. The natural extension of this work to non-fatal crashes and a piece of future work.
