...
I built this in Next.js 16 with Tailwind CSS 4 and no UI library. Cursor and Claude were the pair-programmers for every decision below - the design choices are mine, the iteration speed wasn't. The decisions that felt arbitrary at the time turned out to be load-bearing.
