...
A separate handoff document (`HANDOFF.md` at repo root) specifies the CMS, component structure, and file conventions for this site. Reference that document for anything related to implementation. These instructions cover **content and copy only**.
...
_For voice, tone, and writing style guidance, see [`VOICE.md`](VOICE.md)._
